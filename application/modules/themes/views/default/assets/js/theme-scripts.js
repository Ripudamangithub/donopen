...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a title="khanagadi - home" href="index.html"><img alt="" src="images/logo.png"></a></h1>').insertBefore('.chaser .menu');
    ...
    // sort of trip
   /** tjq(".khana-sonar a").click(function(e) {
        e.preventDefault();
...
// login box
tjq("body").on("click", ".khanagadi-signup-box .signup-email", function(e) {
    e.preventDefault();
    tjq(this).closest(".khanagadi-signup-box").find(".simple-signup").hide();
    tjq(this).closest(".khanagadi-signup-box").find(".email-signup").show();
    tjq(this).closest(".khanagadi-signup-box").find(".email-signup").find(".input-text").eq(0).focus();
});
