...
<!--            <img class="" alt="" src="--><?php //echo theme_url();?><!--/assets/img/featured_img.png">-->
            <div class="img-box-4-content">
                ...
                <h4 class="item-title"><a href="<?php echo $detail_link;?>" title="<?php echo get_post_data_by_lang($post,'title');?>"><?php echo get_post_data_by_lang($post,'title');?></a></h4>
                <div class="row">
                    <?php
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 info-dta"><small><?php echo get_category_title_by_id($post->parent_category); ?></small><small class="pull-right"><?php echo date('M d, Y', $post->create_time); ?></small></div>
                </div>
                <div class="row" style="padding: 5px 0 0px;border-top: 1px solid #EFEFEF;">
                    <div class="col-xs-12 col-sm-12 col-md-12 info-dta"><button type="button" onClick="location.href='<?php echo $detail_link;?>'" class="btn btn-warning btn-embossed btn-block"><?php echo lang_key('View Details'); ?></button></div>
                </div>
