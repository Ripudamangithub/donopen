...
<link href="<?php echo theme_url();?>/assets/css/chosen1.css" rel="stylesheet">
                        ...
                        <form role="form" action="<?php echo site_url('show/advfilter')?>" method="post">
                            <div class="row search_bar_full">
								...
								<div class="input-group-btn">
									...
									<input class="form-control form-control2 tags" id="" type="text" placeholder="<?php echo lang_key('type_anything');?>" value="<?php echo (isset($data['plainkey']))?rawurldecode($data['plainkey']):'';?>" name="plainkey">
									<div class="input-group-btn">
							...
							<div class="row search_bar_mini">
                                <div class="col-md-12 col-sm-12">
								<div class="input-group"><input class="form-control form-control2 tags" type="text" placeholder="<?php echo lang_key('type_anything');?>" value="<?php echo (isset($data['plainkey']))?rawurldecode($data['plainkey']):'';?>" name="plainkey">
									<div class="input-group-btn">
										<button type="submit" class="btn btn-color"><i class="fa fa-search square-2 rounded-1 bg-color white"></i></button>
									</div>
								</div>	
                                </div>
                            </div>
