...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 09, 2015 at 07:17 AM
...
INSERT INTO `dc_blog` (`id`, `type`, `featured_img`, `title`, `description`, `created_by`, `create_time`, `status`) VALUES
...
INSERT INTO `dc_categories` (`id`, `title`, `parent`, `fa_icon`, `created_by`, `create_time`, `status`) VALUES
...
--
-- Table structure for table `dc_emailtmpl`
--

CREATE TABLE IF NOT EXISTS `dc_emailtmpl` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `dc_emailtmpl`
--

INSERT INTO `dc_emailtmpl` (`id`, `email_name`, `values`, `status`) VALUES
...
--
-- Table structure for table `dc_locations`
--
...
--
-- Dumping data for table `dc_locations`
--

INSERT INTO `dc_locations` (`id`, `parent`, `parent_country`, `name`, `type`, `status`) VALUES
(1, 0, 0, 'USA', 'country', 1),
...
INSERT INTO `dc_options` (`id`, `key`, `values`, `status`) VALUES
...
(8, 'banner_settings', '{"menu_bg_color":"rgba(48,46,44,0.86)","menu_text_color":"#ffffff","active_menu_text_color":"#ffffff","banner_type":"Layer Slider","search_panel_bg_color":"#beeba2","show_bg_image":false,"search_bg":"vacation_house_interior-wallpaper-1920x1200-1920x664.jpg","map_latitude":"34.0204989","map_longitude":"-118.4117325","map_zoom":"6"}', 1),
(9, 'webadmin_email', '{"contact_email":"shimulcsedu@gmail.com","webadmin_name":"Webadmin","webadmin_email":"support@dbcinfotech.com"}', 1),
...
CREATE TABLE IF NOT EXISTS `dc_packages` (
  `id` int(11) NOT NULL,
...
INSERT INTO `dc_packages` (`id`, `type`, `title`, `description`, `price`, `expiration_time`, `status`) VALUES
(1, 'featured_package', 'Basic', 'Sample Package Description...', '0.00', 30, 1),
(2, 'post_package', 'Normal', '', '10.00', 60, 1),
(3, 'post_package', 'Free', 'Free for 5 days', '0.00', 5, 1);

-- --------------------------------------------------------

--
-- Table structure for table `dc_pages`
--
...
--
-- Dumping data for table `dc_pages`
--

INSERT INTO `dc_pages` (`id`, `alias`, `show_in_menu`, `layout`, `content_from`, `title`, `url`, `content`, `sidebar`, `seo_settings`, `create_time`, `status`, `editable`, `parent`) VALUES
...
--
-- Table structure for table `dc_post_meta`
--

CREATE TABLE IF NOT EXISTS `dc_post_meta` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `dc_post_package`
--

CREATE TABLE IF NOT EXISTS `dc_post_package` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `dc_post_package`
--

INSERT INTO `dc_post_package` (`id`, `unique_id`, `post_id`, `package_id`, `amount`, `request_date`, `activation_date`, `expiration_date`, `is_active`, `status`, `payment_medium`, `payment_type`, `response_log`) VALUES
...
--
-- Table structure for table `dc_slider`
--

CREATE TABLE IF NOT EXISTS `dc_slider` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `dc_slider`
--

INSERT INTO `dc_slider` (`id`, `slide_order`, `featured_img`, `title`, `description`, `created_by`, `create_time`, `status`) VALUES
...
(2, 3, 'img3.png', 'It''s Revolution', 'A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.', 4, 1424070006, 1),
(3, 1, 'img2.png', 'Warm welcome', 'When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove, the headline of Alphabet Village and the subline of her own road, the Line Lane.', 4, 1424070271, 1);
...
INSERT INTO `dc_users` (`id`, `user_type`, `first_name`, `last_name`, `gender`, `profile_photo`, `user_name`, `user_email`, `password`, `remember_me_key`, `recovery_key`, `confirmation_key`, `confirmed`, `confirmed_date`, `status`, `banned`, `banned_date`, `banned_till`) VALUES
(1, 1, 'Admin', 'Doe', 'male', 'propic.jpg', 'admin', 'shimulcsedu@gmail.com', '022f121a7b44a8eec06f4005f43414e2b21bfa9a', '', '', '', 1, '0000-00-00 00:00:00', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `dc_usertype`
--

CREATE TABLE IF NOT EXISTS `dc_usertype` (
  `id` int(3) NOT NULL,
...
--
-- Dumping data for table `dc_usertype`
--

INSERT INTO `dc_usertype` (`id`, `name`, `status`) VALUES
(1, 'admin', 1),
(2, 'business', 1),
(3, 'individual', 1);
...
--
-- Table structure for table `dc_user_meta`
--

CREATE TABLE IF NOT EXISTS `dc_user_meta` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `dc_user_meta`
--

INSERT INTO `dc_user_meta` (`id`, `user_id`, `key`, `value`, `status`) VALUES
(1, 1, 'query_email#1424350613', '{"sender_email":"jhon@dbcinfotech.com","sender_name":"Jhon Doe","subject":"Need to know the price","msg":"Hi,\\r\\nI want to know the price. Please notify me when you are online.\\r\\nThanks<br \\/><br \\/> This email was sent from the following page:<br \\/><a href=\\"http:\\/\\/localhost\\/classifieds\\/index.php\\/en\\/ads\\/54e5bc6c349b2\\/Computers-and-Laptops\\/Macbook-Pro\\" target=\\"_blank\\">http:\\/\\/localhost\\/classifieds\\/index.php\\/en\\/ads\\/54e5bc6c349b2\\/Macbook Pro<\\/a>"}', 1),
(2, 1, 'query_email#1424351451', '{"sender_email":"doe@dbcinfotech.com","sender_name":"Doe","subject":"Want to buy","msg":"Hi,\\r\\nI want to buy your laptop. Can you send me the price.\\r\\nThanks<br \\/><br \\/> This email was sent from the following page:<br \\/><a href=\\"http:\\/\\/localhost\\/classifieds\\/index.php\\/en\\/ads\\/54e5bc6c349b2\\/Computers-and-Laptops\\/Macbook-Pro\\" target=\\"_blank\\">http:\\/\\/localhost\\/classifieds\\/index.php\\/en\\/ads\\/54e5bc6c349b2\\/Macbook Pro<\\/a>"}', 1);

-- --------------------------------------------------------

--
-- Table structure for table `dc_widgets`
--

CREATE TABLE IF NOT EXISTS `dc_widgets` (
  `id` int(11) NOT NULL,
  `name` char(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `dc_widgets`
--

INSERT INTO `dc_widgets` (`id`, `name`, `alias`, `params`, `status`, `editable`) VALUES
...
--
-- Table structure for table `wz_blog`
--

CREATE TABLE IF NOT EXISTS `wz_blog` (
  `id` int(11) NOT NULL,
  `type` char(30) NOT NULL,
  `featured_img` char(200) NOT NULL,
  `title` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `wz_blog`
--

INSERT INTO `wz_blog` (`id`, `type`, `featured_img`, `title`, `description`, `created_by`, `create_time`, `status`) VALUES
(1, 'blog', '2013-chevrolet-express-cargo-van-steel-wheels-980x4761.jpg', '{"ar":"hello world","bn":"","en":"Demo blog post en","es":"","fr":"","nl":"","pt":"","ru":"Demo blog post ru"}', '{"ar":"<p>Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.<\\/p>\\r\\n<p>Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.<\\/p>","bn":"","en":"<p>en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.<\\/p>\\r\\n<p>en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.en demo blog post content.<\\/p>","es":"","fr":"","nl":"","pt":"","ru":"<p>ru demo blog post content.<\\/p>"}', 4, 1423740705, 0),
(2, 'article', 'iphone42.jpg', '{"ar":"","bn":"","en":"Lorem ipsum doller sit amet","es":"","fr":"","nl":"","pt":"","ru":""}', '{"ar":"","bn":"","en":"<p>Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit amet.Lorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit amet.Lorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit amet.Lorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit amet.Lorem ipsum doller sit ametLorem ipsum doller sit amet<\\/p>","es":"","fr":"","nl":"","pt":"","ru":""}', 4, 1424087935, 0),
(3, 'news', '2013-chevrolet-express-cargo-van-steel-wheels-980x4763.jpg', '{"ar":"","bn":"","en":"Lorem ipsum doller sit ametLorem ipsum doller sit amet","es":"","fr":"","nl":"","pt":"","ru":""}', '{"ar":"","bn":"","en":"<p>Lorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit amet<\\/p>\\r\\n<p>Lorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit ametLorem ipsum doller sit amet<\\/p>","es":"","fr":"","nl":"","pt":"","ru":""}', 4, 1424087980, 0),
...
--
-- Table structure for table `wz_blog_meta`
--

CREATE TABLE IF NOT EXISTS `wz_blog_meta` (
  `id` int(11) NOT NULL,
  `blog_id` int(11) NOT NULL,
  `key` char(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `value` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `wz_categories`
--
...
--
-- Dumping data for table `wz_categories`
--

INSERT INTO `wz_categories` (`id`, `title`, `parent`, `fa_icon`, `created_by`, `create_time`, `status`) VALUES
(1, 'electronics', 0, 'fa-lightbulb-o', 1, 0, 0),
(2, 'community', 0, 'fa-users', 1, 0, 1),
(3, 'fashion', 0, 'fa-female', 1, 0, 1),
(4, 'jobs', 0, 'fa-briefcase', 1, 0, 1),
(5, 'matrimonials', 0, 'fa-heart', 1, 0, 1),
...
(44, 'educational', 9, '', 1, 0, 1),
(45, 'medical', 9, '', 1, 0, 1),
(46, 'Consumable Products', 0, 'fa-book', 1, 1444029289, 1),
(47, 'Medical gases & Equips', 0, 'fa-envelope-o', 1, 1444029499, 1),
(48, 'Hospital Furniture', 0, 'fa-car', 1, 1444029523, 1),
(49, 'Sterilization Equipments', 0, 'fa-envelope-o', 1, 1444029536, 1);

-- --------------------------------------------------------

--
-- Table structure for table `wz_emailtmpl`
--

CREATE TABLE IF NOT EXISTS `wz_emailtmpl` (
  `id` int(11) NOT NULL,
  `email_name` char(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `values` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `status` int(1) NOT NULL
...
--
-- Dumping data for table `wz_emailtmpl`
--

INSERT INTO `wz_emailtmpl` (`id`, `email_name`, `values`, `status`) VALUES
(1, 'confirmation_email', '{"subject":"Confirmation email","body":"Hi #username,\\r\\nYour signup is successful. Please follow the below link for activating your account:\\r\\n \\r\\n#activationlink\\r\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\r\\nThanks\\r\\n#webadmin","avl_vars":"#username,#useremail,#activationlink,#webadmin"}', 1),
(2, 'recovery_email', '{"subject":"Recovery email","body":"Hi #username,\\r\\nWe have received an account recovery request from your email. Please follow the below link for setting new password \\r\\n\\r\\n#recoverylink\\r\\n\\r\\nThanks\\r\\n#webadmin","avl_vars":"#username,#recoverylink,#webadmin"}', 1),
...
--
-- Table structure for table `wz_locations`
--

CREATE TABLE IF NOT EXISTS `wz_locations` (
  `id` int(11) NOT NULL,
  `parent` int(11) NOT NULL,
  `parent_country` int(11) NOT NULL,
  `name` char(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `wz_locations`
--

INSERT INTO `wz_locations` (`id`, `parent`, `parent_country`, `name`, `type`, `status`) VALUES
(88, 0, 0, 'India', 'country', 1),
(89, 88, 88, 'Rajasthan', 'state', 1),
(90, 88, 88, 'Delhi', 'state', 1),
(94, 89, 88, 'Jodhpur', 'city', 1),
(95, 88, 88, 'Panjab', 'state', 1),
(96, 88, 88, 'Andra Pradesh', 'state', 1),
(97, 88, 88, 'Arunachal Pradesh', 'state', 1),
(98, 88, 88, 'Assam', 'state', 1),
(99, 88, 88, 'Bihar', 'state', 1),
(100, 88, 88, 'Chhattisgarh', 'state', 1),
(101, 88, 88, 'Goa', 'state', 1),
(102, 88, 88, 'Gujarat', 'state', 1),
(103, 88, 88, 'Haryana', 'state', 1),
(104, 88, 88, 'Himachal Pradesh', 'state', 1),
(105, 88, 88, 'Jammu and Kashmir', 'state', 1),
(106, 88, 88, 'Jharkhand', 'state', 1),
(107, 88, 88, 'Karnataka', 'state', 1),
(108, 88, 88, 'Kerala', 'state', 1),
(109, 88, 88, 'Madya Pradesh', 'state', 1),
(110, 88, 88, 'Maharashtra', 'state', 1),
(111, 88, 88, 'Manipur', 'state', 1),
(112, 88, 88, 'Meghalaya', 'state', 1),
(113, 88, 88, 'Mizoram', 'state', 1),
(114, 88, 88, 'Nagaland', 'state', 1),
(115, 88, 88, 'Orissa', 'state', 1),
(116, 88, 88, 'Punjab', 'state', 1),
(117, 88, 88, 'Rajasthan', 'state', 1),
(118, 88, 88, 'Sikkim', 'state', 1),
(119, 88, 88, 'Tamil Nadu', 'state', 1),
(120, 88, 88, 'Tripura', 'state', 1),
(121, 88, 88, 'Uttaranchal', 'state', 1),
(122, 88, 88, 'Dehradun', 'state', 1),
(123, 88, 88, 'Uttar Pradesh', 'state', 1),
(124, 88, 88, 'West Bengal', 'state', 1),
(125, 89, 88, 'Alwar', 'city', 1),
(126, 89, 88, 'Ajmer', 'city', 1),
(127, 89, 88, 'Bharatpur', 'city', 1),
(128, 89, 88, 'Bikaner', 'city', 1),
(129, 89, 88, 'Bundi', 'city', 1),
(130, 89, 88, 'Chittaurgarh', 'city', 1),
(131, 89, 88, 'Jaipur', 'city', 1),
(132, 89, 88, 'Jaisalmer', 'city', 1),
(133, 89, 88, 'Jodhpur', 'city', 1),
(134, 89, 88, 'Mt Abu', 'city', 1),
(135, 89, 88, 'Pushkar', 'city', 1),
(136, 89, 88, 'Ranakpur', 'city', 1),
(137, 89, 88, 'Churu', 'city', 1),
(138, 89, 88, 'Jhunjhunu', 'city', 1),
(139, 89, 88, 'Sariska', 'city', 1),
(140, 89, 88, 'Udaipur', 'city', 1),
(141, 89, 88, 'Siker', 'city', 1),
(142, 89, 88, 'Kota', 'city', 1),
(143, 89, 88, 'Udaipur\r\n', 'city', 1);

-- --------------------------------------------------------

--
-- Table structure for table `wz_media`
--

CREATE TABLE IF NOT EXISTS `wz_media` (
  `id` int(10) NOT NULL,
  `media_name` char(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `media_url` mediumtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `create_time` datetime NOT NULL,
...
--
-- Table structure for table `wz_options`
--

CREATE TABLE IF NOT EXISTS `wz_options` (
  `id` int(11) NOT NULL,
  `key` char(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `values` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `status` int(1) NOT NULL DEFAULT '1'
...
--
-- Dumping data for table `wz_options`
--

INSERT INTO `wz_options` (`id`, `key`, `values`, `status`) VALUES
(1, 'site_settings', '{"site_title":"Medical Equipments","footer_text":"Medical Equipments 2015, all rights reserved","site_logo":"logo_default.png","site_lang":"en","site_direction":"ltr","site_direction_rules":"required","per_page":"10","default_layout":"1","ga_tracking_code":"","meta_description":"buy sell your products and goods. number one classified cms. Build your own in just two easy steps","key_words":"classified,sell,buy,post,ads,category,pet,electronics","crawl_after":"3"}', 1),
(2, 'active_theme', 'default', 1),
(3, 'positions', '[{"name":"home_page","status":1,"widgets":["category_main","category_counter","featured_posts_main","recent_posts_main","adsense_full_width","top_locations_home"]},{"name":"right_bar_home","status":1,"widgets":["plain_search_widget","top_posts","category_sidebar","fb_likebox","featured_post","recent_post","top_users","adsense_sidebar","top_locations_sidebar"]},{"name":"right_bar_detail","status":1,"widgets":["plain_search_widget","recent_post","top_locations_sidebar"]},{"name":"right_bar_all_users","status":1,"widgets":["plain_search_widget","featured_post","top_locations_sidebar","category_sidebar","recent_post"]},{"name":"right_bar_locations","status":1,"widgets":["plain_search_widget","recent_post","top_locations_sidebar","category_sidebar","featured_post","adsense_sidebar"]},{"name":"right_bar_categories","status":1,"widgets":["plain_search_widget","recent_post","adsense_sidebar","fb_likebox","top_locations_sidebar","category_featured_post"]},{"name":"right_bar_search_page","status":1,"widgets":false},{"name":"right_bar_general","status":1,"widgets":["plain_search_widget","featured_post","top_locations_sidebar","category_sidebar"]},{"name":"right_bar_blog_posts","status":1,"widgets":["plain_search_widget","top_locations_sidebar","featured_post"]},{"name":"footer_first_column","status":1,"widgets":["contact_text"]},{"name":"footer_second_column","status":1,"widgets":["follow_us"]},{"name":"footer_third_column","status":1,"widgets":["short_description"]}]', 1),
(4, 'top_menu', '[{"id":"1","parent":0},{"id":"10","parent":0},{"id":"2","parent":0},{"id":"9","parent":0},{"id":"5","parent":"9"},{"id":"11","parent":"9"},{"id":"3","parent":"9"},{"id":"6","parent":"9"},{"id":"7","parent":"9"},{"id":"8","parent":"9"},{"id":"4","parent":0}]', 1),
(5, 'purchase_key', '', 1),
...
(8, 'banner_settings', '{"top_bar_bg_color":"#fcfcfc","menu_bg_color":"#ffffff","menu_text_color":"#666","active_menu_text_color":"#32c8de","banner_type":"Google Map","search_panel_bg_color":"#ffffff","show_bg_image":"1","search_bg":"heading-back.jpg","map_latitude":"28.4873161","map_longitude":"77.1326065","map_zoom":"6"}', 1),
(9, 'webadmin_email', '{"contact_email":"ripudaman@shrigenesis.com","webadmin_name":"Webadmin","webadmin_email":"ripudaman@shrigenesis.com"}', 1),
(10, 'smtp_settings', '{"smtp_email":"Disable","smtp_email_rules":"required","smtp_host":"ssl:\\/\\/smtp.googlemail.com","smtp_host_rules":"required","smtp_port":"465","smtp_port_rules":"required","smtp_timeout":"30","smtp_timeout_rules":"required","smtp_user":"test@example.com","smtp_user_rules":"required|valid_email","smtp_pass":"1234","smtp_pass_rules":"required","char_set":"utf-8","char_set_rules":"required","new_line":"\\\\r\\\\n","new_line_rules":"required","mail_type":"html","mail_type_rules":"required"}', 1),
(11, 'classified_settings', '{"publish_directly":"Yes","publish_directly_rules":"required","system_currency":"INR","system_currency_type":"0","system_currency_rules":"required","enable_signup":"Yes","enable_signup_rules":"required","hide_posts_if_expired":"No","hide_posts_if_expired_rules":"required","show_admin_agent":"Yes","show_admin_agent_rules":"required","show_state_province":"yes","show_state_province_rules":"required","posts_per_page":"9","posts_per_page_rules":"required","max_price_for_search":"40000","max_price_for_search_rules":"required","currency_placing":"before_with_no_gap","currency_placing_rules":"required","enable_fb_login":"Yes","enable_fb_login_rules":"required","fb_app_id":"1641070389443354","fb_app_id_rules":"required","fb_secret_key":"cdff9e3ca35a2624b790e8cb9ae50d4b","fb_secret_key_rules":"required","enable_comment":"No","enable_comment_rules":"required","fb_comment_app_id":"","fb_comment_app_id_rules":"","disqus_shortname":"","disqus_shortname_rules":""}', 1),
...
--
-- Table structure for table `wz_packages`
--

CREATE TABLE IF NOT EXISTS `wz_packages` (
  `id` int(11) NOT NULL,
  `type` char(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'post_package',
  `title` varchar(300) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `wz_packages`
--

INSERT INTO `wz_packages` (`id`, `type`, `title`, `description`, `price`, `expiration_time`, `status`) VALUES
...
--
-- Table structure for table `wz_pages`
--

CREATE TABLE IF NOT EXISTS `wz_pages` (
  `id` int(11) NOT NULL,
  `alias` char(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `show_in_menu` int(1) NOT NULL DEFAULT '1',
  `layout` int(1) NOT NULL,
...
--
-- Dumping data for table `wz_pages`
--

INSERT INTO `wz_pages` (`id`, `alias`, `show_in_menu`, `layout`, `content_from`, `title`, `url`, `content`, `sidebar`, `seo_settings`, `create_time`, `status`, `editable`, `parent`) VALUES
(1, 'home', 0, 1, 'Url', '[home]', '', '', '', '{"meta_description":"classified buy sell. real estates electronics pets vehicles matrimonial jobs community services fashion search and post your ad Top Featured Posts categories","key_words":"sale,rent,buy,classified,cms,whiz,electronics,real estate,pets,fashion","crawl_after":"3"}', 1444286355, 1, 0, 0),
(2, 'advanced_search', 0, 1, 'Url', '[advanced_search]', 'results', '', '', '{"meta_description":"","key_words":"","crawl_after":""}', 1444286364, 1, 0, 0),
(3, 'about', 0, 1, 'Manual', '[about]', 'page/about', '<p>About Us:</p>\r\n<p>Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet.</p>\r\n<p>Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet. Lorem ipsum doller sit amet.</p>', '<p>Phone : +34534223434</p>\r\n<p>Mail : support@dbcinfotech.com</p>', '{"meta_description":"","key_words":"","crawl_after":""}', 1444286476, 1, 0, 0),
(4, 'contact', 0, 1, 'Url', '[contact]', 'contact', '', '', '{"meta_description":"contact us page for whiz, this meta will be read by search engine","key_words":"classified,buy,sale","crawl_after":"3"}', 1444286310, 1, 1, 0),
(5, 'users', 0, 0, 'Url', '[users]', 'users', '', '', '{"meta_description":"","key_words":"","crawl_after":""}', 1444286449, 1, 1, 0),
(6, 'blog', 0, 0, 'Url', '[blog]', 'blog-posts', '', '', '{"meta_description":"","key_words":"","crawl_after":""}', 1444286325, 1, 1, 0),
(7, 'news', 1, 0, 'Url', '[news]', 'news-posts', '', '', '{"meta_description":"","key_words":"","crawl_after":""}', 1424339480, 1, 1, 0),
(8, 'articles', 0, 0, 'Url', '[articles]', 'article-posts', '', '', '{"meta_description":"","key_words":"","crawl_after":""}', 1444286341, 1, 1, 0),
(9, 'pages', 0, 0, 'Url', '[pages]', '#', '', '', '{"meta_description":"","key_words":"","crawl_after":""}', 1444286430, 1, 1, 0),
(10, 'post_ad', 0, 0, 'Url', '[post_ad]', 'post-ad', '', '', '{"meta_description":"","key_words":"","crawl_after":""}', 1444286468, 1, 1, 0),
(11, 'locations', 0, 2, 'Url', '[locations]', 'locations', '', '', '{"meta_description":"city, state, country","key_words":"city, state, country","crawl_after":"3"}', 1444286481, 1, 1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `wz_posts`
--

CREATE TABLE IF NOT EXISTS `wz_posts` (
  `id` int(11) NOT NULL,
  `unique_id` char(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `title` char(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `description` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
...
--
-- Dumping data for table `wz_posts`
--
...
(10, '54e5b8da23ad2', '{"en":"Construction Work","ru":"","ar":""}', '{"en":"<p>Aliquam vel egestas turpis. Proin sollicitudin imperdiet nisi ac rutrum. Sed imperdiet libero malesuada erat cursus eu pulvinar tellus rhoncus. Ut eget tellus neque, faucibus ornare odio. Fusce sagittis hendrerit mi a sollicitudin. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam ullamcorper libero sed ante auctor vel gravida nunc placerat. Suspendisse molestie posuere sem, in viverra dolor venenatis sit amet. Aliquam gravida nibh quis justo pulvinar luctus. Phasellus a malesuada massa. Mauris elementum tempus nisi, vitae ullamcorper sem ultricies vitae. Nullam consectetur lacinia nisi, quis laoreet magna pulvinar in. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. In hac habitasse platea dictumst.<\\/p>","ru":"","ar":""}', 'construction, building, tab', 'sell', 24, 4, 0, '7000.00', '49 N Scott Ave', '', 1, 7, 80, '85701', '32.2226452', '-110.9699185', 'construction_work.jpg', NULL, NULL, 1, 1424341210, 1424341210, 1424341210, 1, '2015-02-19', '2015-02-24', 0, '2015-03-31', 0, 9, 'construction_work jobs USA  Arizona Tucson 85701 49 N Scott Ave Construction Work   construction, building, tab '),
...
(16, '54e5bef579431', '{"en":"Black Ferrari","ru":"","ar":""}', '{"en":"<p>Aliquam vel egestas turpis. Proin sollicitudin imperdiet nisi ac rutrum. Sed imperdiet libero malesuada erat cursus eu pulvinar tellus rhoncus. Ut eget tellus neque, faucibus ornare odio. Fusce sagittis hendrerit mi a sollicitudin. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam ullamcorper libero sed ante auctor vel gravida nunc placerat. Suspendisse molestie posuere sem, in viverra dolor venenatis sit amet. Aliquam gravida nibh quis justo pulvinar luctus. Phasellus a malesuada massa. Mauris elementum tempus nisi, vitae ullamcorper sem ultricies vitae. Nullam consectetur lacinia nisi, quis laoreet magna pulvinar in. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. In hac habitasse platea dictumst.<\\/p>","ru":"","ar":""}', 'ferrari, luxury, car, sale', 'sell', 37, 8, 0, '80000.00', '1243 King St', '333-100-9900', 1, 13, 85, '32204', '30.3117375', '-81.69433379999998', 'ferrari.jpg', NULL, NULL, 1, 1424342773, 1424342774, 1424342774, 1, '2015-02-19', '2015-02-24', 0, NULL, 0, 6, 'sports_cars vehicles USA  Florida Jacksonville 32204 1243 King St Black Ferrari   ferrari, luxury, car, sale '),
(17, '560ceb81d1040', '{"en":"Laptop for sale in low price","es":"Laptop for sale in low price","ru":"Laptop for sale in low price","ar":"Laptop for sale in low price","de":"Laptop for sale in low price","fr":"Laptop for sa', '{"en":"<h4>Lorem ipsum<\\/h4>\\r\\n<p>Lorem ipsum&nbsp;dolor sit amet, eirmod nonumes sapientem et duo, pri offendit molestiae ei. Labore convenire deterruisset vim ex, an vim partem soluta. Quo te dicam mucius, torquatos voluptatum qui in, sea clita equidem accommodare ut. Sanctus repudiandae vim eu.<\\/p>\\r\\n<h4>Lorem ipsum<\\/h4>\\r\\n<p>Ipsum ludus nonumy his te, eos esse propriae mediocrem ut. An mel wisi persius, per in mentitum expetendis. Pro eripuit molestiae honestatis ex, sint hinc brute sea at. Mea et reque animal accumsan, lorem corpora iudicabit eam eu. Sint quando appareat vix te, in nec fabulas adolescens. Nam ex quaeque ceteros, summo everti iriure ea qui, mel no vocibus assentior constituam.<\\/p>\\r\\n<p>&nbsp;<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Qui eu lobortis omittantur, eum regione indoctum corrumpit id, ex his nostro lucilius. Ex malorum legendos salutatus pri, case assum adipisci cu sea. Vis quidam sapientem an. Est utroque praesent mediocrem te, duo ei sale legere maiestatis. Cum iusto civibus rationibus et.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Sea solum ancillae accommodare ut. Id pro fugit scripta, vis graeci nostrud et. Aeque accusata ex sed, per equidem nominati cu. Vel assum tollit in, everti utamur cu duo, libris mediocrem explicari et has. Duo atqui inani voluptatum an.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Vis ad accumsan phaedrum, probo accusam vim ex. Ad mea urbanitas voluptatum. Omnes everti denique ex nam. Id nec nonumy mucius. Usu cu lorem deleniti.<\\/p>","es":"<h4>Lorem ipsum<\\/h4>\\r\\n<p>Lorem ipsum&nbsp;dolor sit amet, eirmod nonumes sapientem et duo, pri offendit molestiae ei. Labore convenire deterruisset vim ex, an vim partem soluta. Quo te dicam mucius, torquatos voluptatum qui in, sea clita equidem accommodare ut. Sanctus repudiandae vim eu.<\\/p>\\r\\n<h4>Lorem ipsum<\\/h4>\\r\\n<p>Ipsum ludus nonumy his te, eos esse propriae mediocrem ut. An mel wisi persius, per in mentitum expetendis. Pro eripuit molestiae honestatis ex, sint hinc brute sea at. Mea et reque animal accumsan, lorem corpora iudicabit eam eu. Sint quando appareat vix te, in nec fabulas adolescens. Nam ex quaeque ceteros, summo everti iriure ea qui, mel no vocibus assentior constituam.<\\/p>\\r\\n<p>&nbsp;<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Qui eu lobortis omittantur, eum regione indoctum corrumpit id, ex his nostro lucilius. Ex malorum legendos salutatus pri, case assum adipisci cu sea. Vis quidam sapientem an. Est utroque praesent mediocrem te, duo ei sale legere maiestatis. Cum iusto civibus rationibus et.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Sea solum ancillae accommodare ut. Id pro fugit scripta, vis graeci nostrud et. Aeque accusata ex sed, per equidem nominati cu. Vel assum tollit in, everti utamur cu duo, libris mediocrem explicari et has. Duo atqui inani voluptatum an.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Vis ad accumsan phaedrum, probo accusam vim ex. Ad mea urbanitas voluptatum. Omnes everti denique ex nam. Id nec nonumy mucius. Usu cu lorem deleniti.<\\/p>","ru":"<h4>Lorem ipsum<\\/h4>\\r\\n<p>Lorem ipsum&nbsp;dolor sit amet, eirmod nonumes sapientem et duo, pri offendit molestiae ei. Labore convenire deterruisset vim ex, an vim partem soluta. Quo te dicam mucius, torquatos voluptatum qui in, sea clita equidem accommodare ut. Sanctus repudiandae vim eu.<\\/p>\\r\\n<h4>Lorem ipsum<\\/h4>\\r\\n<p>Ipsum ludus nonumy his te, eos esse propriae mediocrem ut. An mel wisi persius, per in mentitum expetendis. Pro eripuit molestiae honestatis ex, sint hinc brute sea at. Mea et reque animal accumsan, lorem corpora iudicabit eam eu. Sint quando appareat vix te, in nec fabulas adolescens. Nam ex quaeque ceteros, summo everti iriure ea qui, mel no vocibus assentior constituam.<\\/p>\\r\\n<p>&nbsp;<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Qui eu lobortis omittantur, eum regione indoctum corrumpit id, ex his nostro lucilius. Ex malorum legendos salutatus pri, case assum adipisci cu sea. Vis quidam sapientem an. Est utroque praesent mediocrem te, duo ei sale legere maiestatis. Cum iusto civibus rationibus et.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Sea solum ancillae accommodare ut. Id pro fugit scripta, vis graeci nostrud et. Aeque accusata ex sed, per equidem nominati cu. Vel assum tollit in, everti utamur cu duo, libris mediocrem explicari et has. Duo atqui inani voluptatum an.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Vis ad accumsan phaedrum, probo accusam vim ex. Ad mea urbanitas voluptatum. Omnes everti denique ex nam. Id nec nonumy mucius. Usu cu lorem deleniti.<\\/p>","ar":"<h4>Lorem ipsum<\\/h4>\\r\\n<p>Lorem ipsum&nbsp;dolor sit amet, eirmod nonumes sapientem et duo, pri offendit molestiae ei. Labore convenire deterruisset vim ex, an vim partem soluta. Quo te dicam mucius, torquatos voluptatum qui in, sea clita equidem accommodare ut. Sanctus repudiandae vim eu.<\\/p>\\r\\n<h4>Lorem ipsum<\\/h4>\\r\\n<p>Ipsum ludus nonumy his te, eos esse propriae mediocrem ut. An mel wisi persius, per in mentitum expetendis. Pro eripuit molestiae honestatis ex, sint hinc brute sea at. Mea et reque animal accumsan, lorem corpora iudicabit eam eu. Sint quando appareat vix te, in nec fabulas adolescens. Nam ex quaeque ceteros, summo everti iriure ea qui, mel no vocibus assentior constituam.<\\/p>\\r\\n<p>&nbsp;<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Qui eu lobortis omittantur, eum regione indoctum corrumpit id, ex his nostro lucilius. Ex malorum legendos salutatus pri, case assum adipisci cu sea. Vis quidam sapientem an. Est utroque praesent mediocrem te, duo ei sale legere maiestatis. Cum iusto civibus rationibus et.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Sea solum ancillae accommodare ut. Id pro fugit scripta, vis graeci nostrud et. Aeque accusata ex sed, per equidem nominati cu. Vel assum tollit in, everti utamur cu duo, libris mediocrem explicari et has. Duo atqui inani voluptatum an.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Vis ad accumsan phaedrum, probo accusam vim ex. Ad mea urbanitas voluptatum. Omnes everti denique ex nam. Id nec nonumy mucius. Usu cu lorem deleniti.<\\/p>","de":"<h4>Lorem ipsum<\\/h4>\\r\\n<p>Lorem ipsum&nbsp;dolor sit amet, eirmod nonumes sapientem et duo, pri offendit molestiae ei. Labore convenire deterruisset vim ex, an vim partem soluta. Quo te dicam mucius, torquatos voluptatum qui in, sea clita equidem accommodare ut. Sanctus repudiandae vim eu.<\\/p>\\r\\n<h4>Lorem ipsum<\\/h4>\\r\\n<p>Ipsum ludus nonumy his te, eos esse propriae mediocrem ut. An mel wisi persius, per in mentitum expetendis. Pro eripuit molestiae honestatis ex, sint hinc brute sea at. Mea et reque animal accumsan, lorem corpora iudicabit eam eu. Sint quando appareat vix te, in nec fabulas adolescens. Nam ex quaeque ceteros, summo everti iriure ea qui, mel no vocibus assentior constituam.<\\/p>\\r\\n<p>&nbsp;<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Qui eu lobortis omittantur, eum regione indoctum corrumpit id, ex his nostro lucilius. Ex malorum legendos salutatus pri, case assum adipisci cu sea. Vis quidam sapientem an. Est utroque praesent mediocrem te, duo ei sale legere maiestatis. Cum iusto civibus rationibus et.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Sea solum ancillae accommodare ut. Id pro fugit scripta, vis graeci nostrud et. Aeque accusata ex sed, per equidem nominati cu. Vel assum tollit in, everti utamur cu duo, libris mediocrem explicari et has. Duo atqui inani voluptatum an.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Vis ad accumsan phaedrum, probo accusam vim ex. Ad mea urbanitas voluptatum. Omnes everti denique ex nam. Id nec nonumy mucius. Usu cu lorem deleniti.<\\/p>","fr":"<h4>Lorem ipsum<\\/h4>\\r\\n<p>Lorem ipsum&nbsp;dolor sit amet, eirmod nonumes sapientem et duo, pri offendit molestiae ei. Labore convenire deterruisset vim ex, an vim partem soluta. Quo te dicam mucius, torquatos voluptatum qui in, sea clita equidem accommodare ut. Sanctus repudiandae vim eu.<\\/p>\\r\\n<h4>Lorem ipsum<\\/h4>\\r\\n<p>Ipsum ludus nonumy his te, eos esse propriae mediocrem ut. An mel wisi persius, per in mentitum expetendis. Pro eripuit molestiae honestatis ex, sint hinc brute sea at. Mea et reque animal accumsan, lorem corpora iudicabit eam eu. Sint quando appareat vix te, in nec fabulas adolescens. Nam ex quaeque ceteros, summo everti iriure ea qui, mel no vocibus assentior constituam.<\\/p>\\r\\n<p>&nbsp;<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Qui eu lobortis omittantur, eum regione indoctum corrumpit id, ex his nostro lucilius. Ex malorum legendos salutatus pri, case assum adipisci cu sea. Vis quidam sapientem an. Est utroque praesent mediocrem te, duo ei sale legere maiestatis. Cum iusto civibus rationibus et.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Sea solum ancillae accommodare ut. Id pro fugit scripta, vis graeci nostrud et. Aeque accusata ex sed, per equidem nominati cu. Vel assum tollit in, everti utamur cu duo, libris mediocrem explicari et has. Duo atqui inani voluptatum an.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Vis ad accumsan phaedrum, probo accusam vim ex. Ad mea urbanitas voluptatum. Omnes everti denique ex nam. Id nec nonumy mucius. Usu cu lorem deleniti.<\\/p>","it":"<h4>Lorem ipsum<\\/h4>\\r\\n<p>Lorem ipsum&nbsp;dolor sit amet, eirmod nonumes sapientem et duo, pri offendit molestiae ei. Labore convenire deterruisset vim ex, an vim partem soluta. Quo te dicam mucius, torquatos voluptatum qui in, sea clita equidem accommodare ut. Sanctus repudiandae vim eu.<\\/p>\\r\\n<h4>Lorem ipsum<\\/h4>\\r\\n<p>Ipsum ludus nonumy his te, eos esse propriae mediocrem ut. An mel wisi persius, per in mentitum expetendis. Pro eripuit molestiae honestatis ex, sint hinc brute sea at. Mea et reque animal accumsan, lorem corpora iudicabit eam eu. Sint quando appareat vix te, in nec fabulas adolescens. Nam ex quaeque ceteros, summo everti iriure ea qui, mel no vocibus assentior constituam.<\\/p>\\r\\n<p>&nbsp;<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Qui eu lobortis omittantur, eum regione indoctum corrumpit id, ex his nostro lucilius. Ex malorum legendos salutatus pri, case assum adipisci cu sea. Vis quidam sapientem an. Est utroque praesent mediocrem te, duo ei sale legere maiestatis. Cum iusto civibus rationibus et.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Sea solum ancillae accommodare ut. Id pro fugit scripta, vis graeci nostrud et. Aeque accusata ex sed, per equidem nominati cu. Vel assum tollit in, everti utamur cu duo, libris mediocrem explicari et has. Duo atqui inani voluptatum an.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Vis ad accumsan phaedrum, probo accusam vim ex. Ad mea urbanitas voluptatum. Omnes everti denique ex nam. Id nec nonumy mucius. Usu cu lorem deleniti.<\\/p>","pt":"<h4>Lorem ipsum<\\/h4>\\r\\n<p>Lorem ipsum&nbsp;dolor sit amet, eirmod nonumes sapientem et duo, pri offendit molestiae ei. Labore convenire deterruisset vim ex, an vim partem soluta. Quo te dicam mucius, torquatos voluptatum qui in, sea clita equidem accommodare ut. Sanctus repudiandae vim eu.<\\/p>\\r\\n<h4>Lorem ipsum<\\/h4>\\r\\n<p>Ipsum ludus nonumy his te, eos esse propriae mediocrem ut. An mel wisi persius, per in mentitum expetendis. Pro eripuit molestiae honestatis ex, sint hinc brute sea at. Mea et reque animal accumsan, lorem corpora iudicabit eam eu. Sint quando appareat vix te, in nec fabulas adolescens. Nam ex quaeque ceteros, summo everti iriure ea qui, mel no vocibus assentior constituam.<\\/p>\\r\\n<p>&nbsp;<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Qui eu lobortis omittantur, eum regione indoctum corrumpit id, ex his nostro lucilius. Ex malorum legendos salutatus pri, case assum adipisci cu sea. Vis quidam sapientem an. Est utroque praesent mediocrem te, duo ei sale legere maiestatis. Cum iusto civibus rationibus et.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Sea solum ancillae accommodare ut. Id pro fugit scripta, vis graeci nostrud et. Aeque accusata ex sed, per equidem nominati cu. Vel assum tollit in, everti utamur cu duo, libris mediocrem explicari et has. Duo atqui inani voluptatum an.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Vis ad accumsan phaedrum, probo accusam vim ex. Ad mea urbanitas voluptatum. Omnes everti denique ex nam. Id nec nonumy mucius. Usu cu lorem deleniti.<\\/p>","tr":"<h4>Lorem ipsum<\\/h4>\\r\\n<p>Lorem ipsum&nbsp;dolor sit amet, eirmod nonumes sapientem et duo, pri offendit molestiae ei. Labore convenire deterruisset vim ex, an vim partem soluta. Quo te dicam mucius, torquatos voluptatum qui in, sea clita equidem accommodare ut. Sanctus repudiandae vim eu.<\\/p>\\r\\n<h4>Lorem ipsum<\\/h4>\\r\\n<p>Ipsum ludus nonumy his te, eos esse propriae mediocrem ut. An mel wisi persius, per in mentitum expetendis. Pro eripuit molestiae honestatis ex, sint hinc brute sea at. Mea et reque animal accumsan, lorem corpora iudicabit eam eu. Sint quando appareat vix te, in nec fabulas adolescens. Nam ex quaeque ceteros, summo everti iriure ea qui, mel no vocibus assentior constituam.<\\/p>\\r\\n<p>&nbsp;<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Qui eu lobortis omittantur, eum regione indoctum corrumpit id, ex his nostro lucilius. Ex malorum legendos salutatus pri, case assum adipisci cu sea. Vis quidam sapientem an. Est utroque praesent mediocrem te, duo ei sale legere maiestatis. Cum iusto civibus rationibus et.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Sea solum ancillae accommodare ut. Id pro fugit scripta, vis graeci nostrud et. Aeque accusata ex sed, per equidem nominati cu. Vel assum tollit in, everti utamur cu duo, libris mediocrem explicari et has. Duo atqui inani voluptatum an.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Vis ad accumsan phaedrum, probo accusam vim ex. Ad mea urbanitas voluptatum. Omnes everti denique ex nam. Id nec nonumy mucius. Usu cu lorem deleniti.<\\/p>","hi":"<h4>Lorem ipsum<\\/h4>\\r\\n<p>Lorem ipsum&nbsp;dolor sit amet, eirmod nonumes sapientem et duo, pri offendit molestiae ei. Labore convenire deterruisset vim ex, an vim partem soluta. Quo te dicam mucius, torquatos voluptatum qui in, sea clita equidem accommodare ut. Sanctus repudiandae vim eu.<\\/p>\\r\\n<h4>Lorem ipsum<\\/h4>\\r\\n<p>Ipsum ludus nonumy his te, eos esse propriae mediocrem ut. An mel wisi persius, per in mentitum expetendis. Pro eripuit molestiae honestatis ex, sint hinc brute sea at. Mea et reque animal accumsan, lorem corpora iudicabit eam eu. Sint quando appareat vix te, in nec fabulas adolescens. Nam ex quaeque ceteros, summo everti iriure ea qui, mel no vocibus assentior constituam.<\\/p>\\r\\n<p>&nbsp;<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Qui eu lobortis omittantur, eum regione indoctum corrumpit id, ex his nostro lucilius. Ex malorum legendos salutatus pri, case assum adipisci cu sea. Vis quidam sapientem an. Est utroque praesent mediocrem te, duo ei sale legere maiestatis. Cum iusto civibus rationibus et.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Sea solum ancillae accommodare ut. Id pro fugit scripta, vis graeci nostrud et. Aeque accusata ex sed, per equidem nominati cu. Vel assum tollit in, everti utamur cu duo, libris mediocrem explicari et has. Duo atqui inani voluptatum an.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Vis ad accumsan phaedrum, probo accusam vim ex. Ad mea urbanitas voluptatum. Omnes everti denique ex nam. Id nec nonumy mucius. Usu cu lorem deleniti.<\\/p>","bn":"<h4>Lorem ipsum<\\/h4>\\r\\n<p>Lorem ipsum&nbsp;dolor sit amet, eirmod nonumes sapientem et duo, pri offendit molestiae ei. Labore convenire deterruisset vim ex, an vim partem soluta. Quo te dicam mucius, torquatos voluptatum qui in, sea clita equidem accommodare ut. Sanctus repudiandae vim eu.<\\/p>\\r\\n<h4>Lorem ipsum<\\/h4>\\r\\n<p>Ipsum ludus nonumy his te, eos esse propriae mediocrem ut. An mel wisi persius, per in mentitum expetendis. Pro eripuit molestiae honestatis ex, sint hinc brute sea at. Mea et reque animal accumsan, lorem corpora iudicabit eam eu. Sint quando appareat vix te, in nec fabulas adolescens. Nam ex quaeque ceteros, summo everti iriure ea qui, mel no vocibus assentior constituam.<\\/p>\\r\\n<p>&nbsp;<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Qui eu lobortis omittantur, eum regione indoctum corrumpit id, ex his nostro lucilius. Ex malorum legendos salutatus pri, case assum adipisci cu sea. Vis quidam sapientem an. Est utroque praesent mediocrem te, duo ei sale legere maiestatis. Cum iusto civibus rationibus et.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Sea solum ancillae accommodare ut. Id pro fugit scripta, vis graeci nostrud et. Aeque accusata ex sed, per equidem nominati cu. Vel assum tollit in, everti utamur cu duo, libris mediocrem explicari et has. Duo atqui inani voluptatum an.<\\/p>\\r\\n<h4><strong>Lorem ipsum<\\/strong><\\/h4>\\r\\n<p>Vis ad accumsan phaedrum, probo accusam vim ex. Ad mea urbanitas voluptatum. Omnes everti denique ex nam. Id nec nonumy mucius. Usu cu lorem deleniti.<\\/p>"}', '', 'sell', 2, 2, 0, '35000.00', 's-42, Visveshraya Nagar, Triveni Nagar,jaipur', '0', 88, 89, 93, '302018', '28.4873161', '77.1326065', '1.jpg', '', '["6877309607_d3b975a718_o.jpg","6959914079_dcc7fd77f0_o.jpg","dsc_0024.png","dsc_0024.jpg","best-deals-for-desktop-computer.jpg","8676391524_6abfa93073_o.jpg"]', 1, 1443687297, 1443687297, 1444203092, 1, NULL, NULL, 0, '2015-10-02', 0, 17, 'Community Community India Rajasthan N/A 302018 s-42, Visveshraya Nagar, Triveni Nagar,jaipur Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price  '),
(18, '56127fac6f7ff', '{"en":"Laptop for sale in low price","es":"","ru":"","ar":"","de":"","fr":"","it":"","pt":"","tr":"","hi":"","bn":""}', '{"en":"<p>awwadawdawdadw &nbsp;wdaw dad awdawd awd&nbsp;<\\/p>","es":"","ru":"","ar":"","de":"","fr":"","it":"","pt":"","tr":"","hi":"","bn":""}', '', 'sell', 5, 5, 1, '0.00', 'd-21/22', '09782977550', 88, 89, 93, '444004', '28.4873161', '77.1326065', '2048_528a0c879a971.jpg', NULL, NULL, 2, 1444052908, 1444052908, 1444052908, 1, NULL, NULL, 0, NULL, 0, 2, 'Matrimonials Matrimonials India Rajasthan jaipur 444004 d-21/22 Laptop for sale in low price            '),
(19, '5614c9a17594f', '{"en":"Laptop for sale in low price","es":"Laptop for sale in low price","ru":"Laptop for sale in low price","ar":"Laptop for sale in low price","de":"Laptop for sale in low price","fr":"Laptop for sa', '{"en":"<p>;ohu uy iut oiutouytut outoiutyioutiut oiut iut iut iu oiu oiut oiut oiu oiu oiuoiut ioutoiut oyoiut oiut gout oiutiouty iotiutoiut iutoi ut ut iutyoiut outoiuto iutoituoiut oiuto ot t t uot ioutoiut outo iut it iout&nbsp;<\\/p>","es":"<p>;ohu uy iut oiutouytut outoiutyioutiut oiut iut iut iu oiu oiut oiut oiu oiu oiuoiut ioutoiut oyoiut oiut gout oiutiouty iotiutoiut iutoi ut ut iutyoiut outoiuto iutoituoiut oiuto ot t t uot ioutoiut outo iut it iout&nbsp;<\\/p>","ru":"<p>;ohu uy iut oiutouytut outoiutyioutiut oiut iut iut iu oiu oiut oiut oiu oiu oiuoiut ioutoiut oyoiut oiut gout oiutiouty iotiutoiut iutoi ut ut iutyoiut outoiuto iutoituoiut oiuto ot t t uot ioutoiut outo iut it iout&nbsp;<\\/p>","ar":"<p>;ohu uy iut oiutouytut outoiutyioutiut oiut iut iut iu oiu oiut oiut oiu oiu oiuoiut ioutoiut oyoiut oiut gout oiutiouty iotiutoiut iutoi ut ut iutyoiut outoiuto iutoituoiut oiuto ot t t uot ioutoiut outo iut it iout&nbsp;<\\/p>","de":"<p>;ohu uy iut oiutouytut outoiutyioutiut oiut iut iut iu oiu oiut oiut oiu oiu oiuoiut ioutoiut oyoiut oiut gout oiutiouty iotiutoiut iutoi ut ut iutyoiut outoiuto iutoituoiut oiuto ot t t uot ioutoiut outo iut it iout&nbsp;<\\/p>","fr":"<p>;ohu uy iut oiutouytut outoiutyioutiut oiut iut iut iu oiu oiut oiut oiu oiu oiuoiut ioutoiut oyoiut oiut gout oiutiouty iotiutoiut iutoi ut ut iutyoiut outoiuto iutoituoiut oiuto ot t t uot ioutoiut outo iut it iout&nbsp;<\\/p>","it":"<p>;ohu uy iut oiutouytut outoiutyioutiut oiut iut iut iu oiu oiut oiut oiu oiu oiuoiut ioutoiut oyoiut oiut gout oiutiouty iotiutoiut iutoi ut ut iutyoiut outoiuto iutoituoiut oiuto ot t t uot ioutoiut outo iut it iout&nbsp;<\\/p>","pt":"<p>;ohu uy iut oiutouytut outoiutyioutiut oiut iut iut iu oiu oiut oiut oiu oiu oiuoiut ioutoiut oyoiut oiut gout oiutiouty iotiutoiut iutoi ut ut iutyoiut outoiuto iutoituoiut oiuto ot t t uot ioutoiut outo iut it iout&nbsp;<\\/p>","tr":"<p>;ohu uy iut oiutouytut outoiutyioutiut oiut iut iut iu oiu oiut oiut oiu oiu oiuoiut ioutoiut oyoiut oiut gout oiutiouty iotiutoiut iutoi ut ut iutyoiut outoiuto iutoituoiut oiuto ot t t uot ioutoiut outo iut it iout&nbsp;<\\/p>","hi":"<p>;ohu uy iut oiutouytut outoiutyioutiut oiut iut iut iu oiu oiut oiut oiu oiu oiuoiut ioutoiut oyoiut oiut gout oiutiouty iotiutoiut iutoi ut ut iutyoiut outoiuto iutoituoiut oiuto ot t t uot ioutoiut outo iut it iout&nbsp;<\\/p>","bn":"<p>;ohu uy iut oiutouytut outoiutyioutiut oiut iut iut iu oiu oiut oiut oiu oiu oiuoiut ioutoiut oyoiut oiut gout oiutiouty iotiutoiut iutoi ut ut iutyoiut outoiuto iutoituoiut oiuto ot t t uot ioutoiut outo iut it iout&nbsp;<\\/p>"}', 'comma,sperated', 'sell', 2, 2, 0, '35.00', 's-42, Visveshraya Nagar, Triveni Nagar', '0', 88, 89, 131, '302018', '26.863687', '75.77594699999997', '1388240899_beautiful_jewelry_model_hd1.jpg', 'https://www.youtube.com/watch?v=5mZovjRlkWs', '[]', 1, 1444202913, 1444202913, 1444206583, 1, NULL, NULL, 0, NULL, 0, 3, 'Community Community India Rajasthan Jaipur 302018 s-42, Visveshraya Nagar, Triveni Nagar Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price Laptop for sale in low price comma,sperated '),
(20, '5614dbe16d465', '{"en":"Hospital beds in good conditions","es":"","ru":"","ar":"","de":"","fr":"","it":"","pt":"","tr":"","hi":"","bn":""}', '{"en":"<p>Hospital beds in good conditions&nbsp;Hospital beds in good conditions&nbsp;Hospital beds in good conditions&nbsp;Hospital beds in good conditions&nbsp;Hospital beds in good conditions&nbsp;Hospital beds in good conditions&nbsp;Hospital beds in good conditions&nbsp;Hospital beds in good conditions<\\/p>","es":"","ru":"","ar":"","de":"","fr":"","it":"","pt":"","tr":"","hi":"","bn":""}', 'Hospital,Beds,Good,Conditions', 'sell', 43, 9, 0, '35.00', 's-42, Visveshraya Nagar, Triveni Nagar', '09876543210', 88, 89, 131, '302018', '26.863687', '75.77594699999997', '20130122_173141.jpg', NULL, '["Gun-collection-hd-wallpaper-backgrounds.jpg","Gun_002.jpg","dsc_00241.jpg","ar-15-gun-photography-hd-wallpaper-1920x1200-9914.jpg","B0FBF105.jpg","E.jpg","best-car-wallpapers-hd-for-desktopcool-car-wallpapers-hd-desktop-wallpapers-5440-high-definition-t5z0jdhm.jpg"]', 1, 1444207585, 1444207585, 1444207585, 1, NULL, NULL, 0, NULL, 0, 1, 'Moving Service Services India Rajasthan Jaipur 302018 s-42, Visveshraya Nagar, Triveni Nagar Hospital beds in good conditions           Hospital,Beds,Good,Conditions ');

-- --------------------------------------------------------

--
-- Table structure for table `wz_post_meta`
--

CREATE TABLE IF NOT EXISTS `wz_post_meta` (
  `id` int(11) NOT NULL,
  `post_id` int(11) NOT NULL,
  `key` char(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `value` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `wz_post_package`
--

CREATE TABLE IF NOT EXISTS `wz_post_package` (
  `id` int(11) NOT NULL,
  `unique_id` char(100) NOT NULL,
  `post_id` int(15) NOT NULL,
  `package_id` int(11) NOT NULL,
...
--
-- Dumping data for table `wz_post_package`
--

INSERT INTO `wz_post_package` (`id`, `unique_id`, `post_id`, `package_id`, `amount`, `request_date`, `activation_date`, `expiration_date`, `is_active`, `status`, `payment_medium`, `payment_type`, `response_log`) VALUES
(1, '54e5b1ea4eb01', 1, 3, '0.00', '2015-02-19', '2015-02-19', '2015-02-24', 1, 1, 'paypal', 'post', 'Free package'),
(2, '54e5b2c8d9bf6', 2, 3, '0.00', '2015-02-19', '2015-02-19', '2015-02-24', 1, 1, 'paypal', 'post', 'Free package'),
(3, '54e5b36f23dc0', 3, 3, '0.00', '2015-02-19', '2015-02-19', '2015-02-24', 1, 1, 'paypal', 'post', 'Free package'),
(4, '54e5b40b85349', 4, 3, '0.00', '2015-02-19', '2015-02-19', '2015-02-24', 1, 1, 'paypal', 'post', 'Free package'),
...
--
-- Table structure for table `wz_slider`
--

CREATE TABLE IF NOT EXISTS `wz_slider` (
  `id` int(11) NOT NULL,
  `slide_order` int(11) NOT NULL DEFAULT '0',
  `featured_img` char(200) NOT NULL,
  `title` char(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `wz_slider`
--

INSERT INTO `wz_slider` (`id`, `slide_order`, `featured_img`, `title`, `description`, `created_by`, `create_time`, `status`) VALUES
(1, 2, 'img1.png', ' Easy management', 'Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.', 4, 1424069935, 1),
...
--
-- Dumping data for table `wz_users`
--

INSERT INTO `wz_users` (`id`, `user_type`, `first_name`, `last_name`, `gender`, `profile_photo`, `user_name`, `user_email`, `password`, `remember_me_key`, `recovery_key`, `confirmation_key`, `confirmed`, `confirmed_date`, `status`, `banned`, `banned_date`, `banned_till`) VALUES
(1, 1, 'medico', '', 'male', '', 'medico', 'ripudaman@shrigenesis.com', '7c9941970829dda09224e8bdaae1406763fb0212', '', '', '', 1, '0000-00-00 00:00:00', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 3, 'Ripudaman', 'shekhawat', 'male', 'jaipur72x72.png', 'ripu', 'rsmicky9@gmail.com', '7c9941970829dda09224e8bdaae1406763fb0212', '', '', '', 1, '2015-10-01 09:46:00', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `wz_usertype`
--

CREATE TABLE IF NOT EXISTS `wz_usertype` (
  `id` int(3) NOT NULL,
  `name` char(20) NOT NULL,
  `status` int(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `wz_usertype`
--

INSERT INTO `wz_usertype` (`id`, `name`, `status`) VALUES
(1, 'admin', 1),
(2, 'business', 1),
(3, 'individual', 1);
...
--
-- Table structure for table `wz_user_meta`
--

CREATE TABLE IF NOT EXISTS `wz_user_meta` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `key` char(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `value` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `wz_user_meta`
--

INSERT INTO `wz_user_meta` (`id`, `user_id`, `key`, `value`, `status`) VALUES
(1, 2, 'phone', '09782977550', 1),
(2, 1, 'query_email#1443696026', '{"sender_email":"ripushri2@gmail.com","sender_name":"Rakesh","subject":"adwad","msg":"awdwadawd<br \\/><br \\/> This email was sent from the following page:<br \\/><a href=\\"http:\\/\\/localhost\\/medico\\/index.php\\/en\\/ads\\/54e5b1e9e2f70\\/Brides\\/Wedding-Photographer\\" target=\\"_blank\\">http:\\/\\/localhost\\/medico\\/index.php\\/en\\/ads\\/54e5b1e9e2f70\\/Wedding Photographer<\\/a>"}', 1),
(3, 1, 'query_email#1443696124', '{"sender_email":"ripushri2@gmail.com","sender_name":"Rakesh","subject":"asdvdsv","msg":"dsvdsvdsv<br \\/><br \\/> This email was sent from the following page:<br \\/><a href=\\"http:\\/\\/localhost\\/medico\\/index.php\\/en\\/ads\\/54e5b1e9e2f70\\/Brides\\/Wedding-Photographer\\" target=\\"_blank\\">http:\\/\\/localhost\\/medico\\/index.php\\/en\\/ads\\/54e5b1e9e2f70\\/Wedding Photographer<\\/a>"}', 1),
(4, 1, 'query_email#1443696215', '{"sender_email":"ripushri2@gmail.com","sender_name":"Rakesh","subject":"asdvdsv","msg":"awdawdawdawd<br \\/><br \\/> This email was sent from the following page:<br \\/><a href=\\"http:\\/\\/localhost\\/medico\\/index.php\\/en\\/ads\\/54e5b1e9e2f70\\/Brides\\/Wedding-Photographer\\" target=\\"_blank\\">http:\\/\\/localhost\\/medico\\/index.php\\/en\\/ads\\/54e5b1e9e2f70\\/Wedding Photographer<\\/a>"}', 1),
(5, 2, 'company_name', '', 1),
(6, 2, 'about_me', '', 1),
(7, 2, 'fb_profile', '', 1),
(8, 2, 'twitter_profile', '', 1),
(9, 2, 'li_profile', '', 1),
(10, 2, 'gp_profile', '', 1),
(11, 1, 'query_email#1443696647', '{"sender_email":"ripushri2@gmail.com","sender_name":"Rakesh","subject":"asdvdsv","msg":"ks sifjlaskj s jalkdjs;lkas;ldkaskaslkas ;lakdjlakdj;aslkdjas;ldkjas;ldkjsldk asdlk s dlaskdjas;lkdjaskljda<br \\/><br \\/> This email was sent from the following page:<br \\/><a href=\\"http:\\/\\/localhost\\/medico\\/index.php\\/en\\/ads\\/54e5b1e9e2f70\\/Brides\\/Wedding-Photographer\\" target=\\"_blank\\">http:\\/\\/localhost\\/medico\\/index.php\\/en\\/ads\\/54e5b1e9e2f70\\/Wedding Photographer<\\/a>"}', 1),
(12, 1, 'query_email#1443702201', '{"sender_email":"ripushri2@gmail.com","sender_name":"Rakesh","subject":"awdadaw","msg":"dawdwadawdawd<br \\/><br \\/> This email was sent from the following page:<br \\/><a href=\\"http:\\/\\/localhost\\/medico\\/index.php\\/en\\/ads\\/560ceb81d1040\\/Computers-and-Laptops\\/Laptop-for-sale-in-low-price\\" target=\\"_blank\\">http:\\/\\/localhost\\/medico\\/index.php\\/en\\/ads\\/560ceb81d1040\\/Laptop for sale in low price<\\/a>"}', 1);

-- --------------------------------------------------------

--
-- Table structure for table `wz_widgets`
--

CREATE TABLE IF NOT EXISTS `wz_widgets` (
  `id` int(11) NOT NULL,
  `name` char(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `alias` char(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `params` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
...
--
-- Dumping data for table `wz_widgets`
--

INSERT INTO `wz_widgets` (`id`, `name`, `alias`, `params`, `status`, `editable`) VALUES
(1, 'Facebook like box', 'fb_likebox', '', 1, 1),
(2, 'Contact text', 'contact_text', '', 1, 1),
(3, 'Follow us', 'follow_us', '', 1, 1),
(4, 'Short Description', 'short_description', '', 1, 1),
...
(9, 'Recent Posts Main', 'recent_posts_main', '', 1, 1),
(10, 'Category Main', 'category_main', '', 1, 1),
(11, 'Top Bar', 'top_bar', NULL, 0, 1),
(12, 'Top Bar Social', 'top_bar_social', NULL, 0, 1),
(13, 'Footer Links', 'footer_links', NULL, 1, 1),
(14, 'Top Posts', 'top_posts', NULL, 1, 1),
(15, 'Category Counter', 'category_counter', NULL, 1, 1),
(16, 'Tag Cloud', 'tag_cloud', NULL, 1, 1),
...
--
-- Indexes for table `dc_blog_meta`
--
ALTER TABLE `dc_blog_meta`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dc_categories`
--
ALTER TABLE `dc_categories`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dc_emailtmpl`
--
ALTER TABLE `dc_emailtmpl`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dc_locations`
--
...
--
-- Indexes for table `dc_pages`
--
ALTER TABLE `dc_pages`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `dc_post_meta`
--
ALTER TABLE `dc_post_meta`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dc_post_package`
--
ALTER TABLE `dc_post_package`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_id` (`unique_id`);

--
-- Indexes for table `dc_sessions`
--
ALTER TABLE `dc_sessions`
  ADD PRIMARY KEY (`session_id`);

--
-- Indexes for table `dc_slider`
--
ALTER TABLE `dc_slider`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `dc_usertype`
--
ALTER TABLE `dc_usertype`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dc_user_meta`
--
ALTER TABLE `dc_user_meta`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dc_widgets`
--
ALTER TABLE `dc_widgets`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wz_blog`
--
ALTER TABLE `wz_blog`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wz_blog_meta`
--
ALTER TABLE `wz_blog_meta`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wz_categories`
--
ALTER TABLE `wz_categories`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wz_emailtmpl`
--
ALTER TABLE `wz_emailtmpl`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wz_locations`
--
ALTER TABLE `wz_locations`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wz_media`
--
ALTER TABLE `wz_media`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wz_options`
--
ALTER TABLE `wz_options`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wz_packages`
--
ALTER TABLE `wz_packages`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wz_pages`
--
ALTER TABLE `wz_pages`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `alias` (`alias`),
  ADD UNIQUE KEY `alias_2` (`alias`);

--
-- Indexes for table `wz_posts`
--
...
--
-- Indexes for table `wz_post_meta`
--
ALTER TABLE `wz_post_meta`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wz_post_package`
--
ALTER TABLE `wz_post_package`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_id` (`unique_id`);

--
-- Indexes for table `wz_sessions`
--
ALTER TABLE `wz_sessions`
  ADD PRIMARY KEY (`session_id`);

--
-- Indexes for table `wz_slider`
--
ALTER TABLE `wz_slider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wz_users`
--
ALTER TABLE `wz_users`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wz_usertype`
--
ALTER TABLE `wz_usertype`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wz_user_meta`
--
ALTER TABLE `wz_user_meta`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wz_widgets`
--
ALTER TABLE `wz_widgets`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `dc_blog`
--
ALTER TABLE `dc_blog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `dc_blog_meta`
--
ALTER TABLE `dc_blog_meta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `dc_categories`
--
ALTER TABLE `dc_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=46;
--
-- AUTO_INCREMENT for table `dc_emailtmpl`
--
ALTER TABLE `dc_emailtmpl`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `dc_locations`
--
ALTER TABLE `dc_locations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=86;
--
-- AUTO_INCREMENT for table `dc_media`
--
ALTER TABLE `dc_media`
...
ALTER TABLE `dc_packages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `dc_pages`
--
ALTER TABLE `dc_pages`
...
--
-- AUTO_INCREMENT for table `dc_post_meta`
--
ALTER TABLE `dc_post_meta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `dc_post_package`
--
ALTER TABLE `dc_post_package`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `dc_slider`
--
ALTER TABLE `dc_slider`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
--
-- AUTO_INCREMENT for table `dc_usertype`
--
ALTER TABLE `dc_usertype`
  MODIFY `id` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `dc_user_meta`
--
ALTER TABLE `dc_user_meta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `dc_widgets`
--
ALTER TABLE `dc_widgets`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=26;
--
-- AUTO_INCREMENT for table `wz_blog`
--
ALTER TABLE `wz_blog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `wz_blog_meta`
--
ALTER TABLE `wz_blog_meta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `wz_categories`
--
ALTER TABLE `wz_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=50;
--
-- AUTO_INCREMENT for table `wz_emailtmpl`
--
ALTER TABLE `wz_emailtmpl`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `wz_locations`
--
ALTER TABLE `wz_locations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=144;
--
-- AUTO_INCREMENT for table `wz_media`
--
ALTER TABLE `wz_media`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `wz_options`
--
ALTER TABLE `wz_options`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `wz_packages`
--
ALTER TABLE `wz_packages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `wz_pages`
--
ALTER TABLE `wz_pages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `wz_posts`
--
ALTER TABLE `wz_posts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT for table `wz_post_meta`
--
ALTER TABLE `wz_post_meta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `wz_post_package`
--
ALTER TABLE `wz_post_package`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `wz_slider`
--
ALTER TABLE `wz_slider`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `wz_users`
--
ALTER TABLE `wz_users`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `wz_usertype`
--
ALTER TABLE `wz_usertype`
  MODIFY `id` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `wz_user_meta`
--
ALTER TABLE `wz_user_meta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `wz_widgets`
--
ALTER TABLE `wz_widgets`
